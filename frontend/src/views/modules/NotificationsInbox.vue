  ...
  data() {
    return {
      ...
      notifications: [
        ...
        { id: 7, category: "project", icon: "schedule", icon_class: "text-info", title: "Phase Status Update", message: "Infrastructure Plan LGU-TUAO-PROJ-003 phase has been updated to Execution.", time: "3 days ago", read: true, action_text: "View Project", action_link: "#infrastructure-plans" },
