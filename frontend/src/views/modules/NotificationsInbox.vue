  ...
  data() {
    return {
      ...
      notifications: [
        ...
        { id: 3, category: "cashflow", icon: "trending_down", icon_class: "text-warning", title: "Budget Variance Alert", message: "Contract REG-II-001 is exceeding the allocated budget by ₱850,000.", time: "1 day ago", read: false, action_text: "View Budget", action_link: "#cashflow" },
        { id: 4, category: "project", icon: "check_circle", icon_class: "text-success", title: "Milestone Completed", message: "Milestone 'Site Mobilization' for Fire Station Construction has been completed.", time: "1 day ago", read: true, action_text: "View Accomplishment", action_link: "#accomplishments" },
        { id: 5, category: "contract", icon: "description", icon_class: "text-info", title: "Contract Document Uploaded", message: "Supplemental Agreement for Contract REG-II-001 has been uploaded.", time: "2 days ago", read: true, action_text: "View Document", action_link: "#contract-management" },
        ...
        { id: 7, category: "project", icon: "schedule", icon_class: "text-info", title: "Phase Status Update", message: "Infrastructure Plan PRO-II-2023-003 phase has been updated to Execution.", time: "3 days ago", read: true, action_text: "View Project", action_link: "#infrastructure-plans" },
        { id: 8, category: "cashflow", icon: "receipt", icon_class: "text-secondary", title: "Invoice Received", message: "Invoice INV-002 has been received from contractor Regi Construction.", time: "4 days ago", read: true, action_text: "Process Invoice", action_link: "#cashflow" }
      ]
    };
  },
  computed: {
