<template>
  <div class="w-auto h-auto collapse navbar-collapse max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item" v-if="hasModuleAccess('projects')">
      ...
      <li class="nav-item" v-if="hasModuleAccess('contracts')">
      ...
      <li class="nav-item" v-if="hasModuleAccess('cashflow_periods')">
      ...
      <li class="nav-item" v-if="hasModuleAccess('engineering_plans')">
      ...
      <li class="nav-item" v-if="hasModuleAccess('variation_orders')">
      ...
      <li class="nav-item" v-if="hasModuleAccess('project_accomplishments')">
      ...
      <li class="nav-item" v-if="hasModuleAccess('reports')">
      ...
      <li class="nav-item" v-if="hasModuleAccess('audit_logs')">
...
export default {
  ...
  methods: {
    hasModuleAccess(module) {
      ...
      return !!profile?.module_permissions?.[module]?.can_view;
    },
    getRoute() {
